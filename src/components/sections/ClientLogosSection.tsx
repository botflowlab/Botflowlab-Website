        ...
        >
          {clients.map((client, index) => (
            ...
            >
              ...
              {/* Logo container */}
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 transition-all duration-500 group-hover:border-white/30 group-hover:bg-white/10">
                <img
                  src={client.logo}
                  alt={client.alt}
